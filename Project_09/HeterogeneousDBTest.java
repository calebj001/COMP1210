...
/**
* Tests the HeterogeneousDB class.
*
...
public class HeterogeneousDBTest
{
   ...
   { 
      ...
      HeterogeneousDB test2
         = new HeterogeneousDB("Database Four", 2000.0, 7.5, 100, 12.0);
   ...
   {
      Assert.assertEquals(1.3, test.getCostFactor(), 0.1);
   }
   
   /** Tests monthlyCost(). **/
   @Test public void monthlyCostTest()
   {
      Assert.assertEquals(3820.00, test.monthlyCost(), 0.01);
   }
   
   /** Test toString(). **/
   @Test public void toStringTest()
   {
      Assert.assertEquals("Database Four (class HeterogeneousDB) Monthly Cost: "
                         + "$3,820.00\nStorage: 7.500 TB\nBase Cost: $2,000.00"
                         + "\nNumber of Users: 100\nCost per User: $14.00\n"
                           + "User Cost: $1,400.00\nCost Factor: 1.3",
                              test.toString());
